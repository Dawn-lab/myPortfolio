...
function Project(){
    return(
        <>    
        <div class="svg logo">
            <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 107.47 122.88">
                <defs>
                </defs>
    ...
    <article>
        ...
        <div class="projects">
            <div class="project">
                <div class="top">
                    <h2>News Website </h2>
                    <a href="https://github.com/Julieus-G/News" >Visit🚀</a>
                </div>
                <div class="info">
                    A basic News Website that displays news articles.
                </div>
                <p>
                    <span><img src="./assets/svg/html.svg" alt=""/></span>
                    <span><img src="./assets/svg/css.svg" alt=""/></span>
                    <span><img src="./assets/svg/google-firebase.svg" alt=""/></span>
                    <span><img src="./assets/svg/node-js.svg" alt=""/></span>
                    <span class="invert"><img src="./assets/svg/expressjs.svg" alt=""/></span>
                </p>
            </div>
            <div class="project">
                <div class="top">
                    <h2>Monster Roledex </h2>
                    <a href="https://github.com/Julieus-G/monsters">Visit🚀</a>
                </div>

                <p>
                    <span><img src="./assets/svg/react-seeklogo.com.svg" alt=""/></span>
                    <span><img src="./assets/svg/css.svg" alt=""/></span>
                </p>
            </div>
            <div class="project">
                <div class="top">
                    <h2> A todo list with local storage </h2>
                    <a href="https://github.com/Julieus-G/bucketlist">Visit🚀</a>
                </div>

                <p>
                    <span><img src="./assets/svg/html.svg" alt=""/></span>
                    <span><img src="./assets/svg/javascript-programming-language.svg" alt=""/></span>
                    <span class="invert"><img src="./assets/svg/css.svg" alt=""/></span>
                </p>
            </div>
            <div class="project">
                <div class="top">
                    <h2>Clock</h2>
                    <a href="https://github.com/Julieus-G/clock">Visit🚀</a>
                </div>

                <p>
                    <span><img src="./assets/svg/html.svg" alt=""/></span>
                    <span><img src="./assets/svg/css.svg" alt=""/></span>
                    <span class="invert"><img src="./assets/svg/javascript-programming-language.svg" alt=""/></span>
                </p>
            </div>
        </div>
    </article>
    ...
    <footer>
        <div class="socials">
            <span class="invert git"><img src="./assets/svg/github.svg" alt=""/></span>
            <span class="twitter"><img src="./assets/svg/twitter-color.svg" alt=""/></span>
            <span class="linkedin"><img src="./assets/svg/linkedin-square-color.svg" alt=""/></span>
        </div>
