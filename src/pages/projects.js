    ...
    return (
        <>
            ...
            <div className="mode">
                ...
                <div className="lighter" id="hidden">
                ...
                <div className="projects">
                    <div className="project">
                        ...
                        <p>
                            ...
                            <span className="invert"><img src="./assets/svg/expressjs.svg" alt="" /></span>
                        </p>
                    </div>
                    <div className="project">
                        <div className="top">
                    ...
                    <div className="project">
                        ...
                        <p>
                            ...
                            <span className="invert"><img src="./assets/svg/css.svg" alt="" /></span>
                        </p>
                    </div>
                    <div className="project">
                        <div className="top">
                        ...
                        <p>
                            <span><img src="./assets/svg/html.svg" alt="" /></span>
                            <span><img src="./assets/svg/css.svg" alt="" /></span>
                            <span className="invert"><img src="./assets/svg/javascript-programming-language.svg" alt="" /></span>
                        </p>
                    </div>
                </div>
            </article>
            ...
            <footer>
                <div className="socials">
                    <span className="invert git"><img src={github} alt="" /></span>
                    <span className="twitter"><img src={twitter} alt="" /></span>
                    <span className="linkedin"><img src={linkedin} alt="" /></span>
                </div>
